...
import { IonicPage, NavController, NavParams, Events, LoadingController,Platform,ModalController,ToastController} from 'ionic-angular';
...
@Component({
  selector: 'page-Acdescription ',
  templateUrl: 'Acdescription.html',
})
export class AcdescriptionPage {
  fedexx: string;
  showimage: any;
  ...
  constructor(
    ...
    imageViewerCtrl: ImageViewerController
      ...
      //this.req_iddd = this.navParams.get('act_id');
      this.req_id= localStorage.getItem('act_id');
      ...
      this.http.post(url, serialized_data, options)
        ...
        .subscribe(resolve => {
          ...
          if (resolve.error == 0) {
            ...
            this.rating.rate=resolve.data[0].rating;
            ...
            console.log(this.shipping_lenght);
            if (this.docUri != "")
              this.fileSelected = 1;
            else
              this.fileSelected = 0;
